...
public class TaskActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener{
    ...
    private void handleSave() {
        ...
        taskModel.setDueDate(this.mViewHolder.buttonDate.getText().toString());
    ...
    private void loadSpinner(List<PriorityModel> priorityModels) {

        List<String> listPriorities = new ArrayList<>();

        for (PriorityModel priorityModel: priorityModels) {
            listPriorities.add(priorityModel.getDescription());
            this.mListPriorityId.add(priorityModel.getId());
        }
